package ru.avem.posvanna.communication.model.devices.avem.avem4
...
class Avem4Controller(
    ...
    private val model = ru.avem.posvanna.communication.model.devices.parma.ParmaModel()
    ...
    fun readChartPoints(): List<Float> {
        ...
        for (registerIndex in startRegister..endRegister - 50 step 50) {
            val dots = protocolAdapter.readHoldingRegisters(id, registerIndex.toShort(), 50).map(ModbusRegister::toShort)
